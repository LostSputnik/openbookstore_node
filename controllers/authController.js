...
exports.restrictTo = (...roles) => {
    return (req, res, next) => {
        ...
        if (!roles.includes(req.user.role)) {
            return next(new AppError('You do no have permission to perform this action', 403));
        }
...
exports.resetPassword = catchAsync(async (req, res, next) => {
    ...
    // 3) Update changedPasswordAt property for the user - this is set up in user model using a pre save hook
...
exports.updatePassword = catchAsync(async (req, res, next) => {
    // 1) Get user from collection - here findByIdAndUpdate will not work
